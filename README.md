...
1. Use the D3 library to read in `samples.json` from the URL `https://uci.bootcampcontent.com/UCI-Coding-Bootcamp/UCI-VIRT-DATA-PT-03-2022-U-LOL/-/blob/main/02-Homework/14-Interactive-Web-Visualizations/Instructions/data/samples.json`.
